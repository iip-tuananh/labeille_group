<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item has-treeview {{request()->is('common/dashboard') ? 'menu-open' : ''}}">
            ...
            <li class="nav-item has-treeview {{request()->is('admin/category_special') || request()->is('admin/category_special/*') ? 'menu-open' : ''}}">
                <a href="{{route('category_special.index')}}" class="nav-link {{request()->is('admin/category_special') || request()->is('admin/category_special/*') ? 'active' : ''}}">
            ...
            <li class="nav-item has-treeview  {{ request()->is('common/products') || request()->is('uptek/products*') || request()->is('admin/categories') || request()->is('admin/categories*') ? 'menu-open' : '' }} ">
                <a href="#" class="nav-link {{request()->is('common/products') || request()->is('uptek/products*') || request()->is('admin/categories') || request()->is('admin/categories*') ? 'active' : ''}}">
            ...
            {{-- <li class="nav-item has-treeview {{request()->is('admin/vouchers') || request()->is('admin/vouchers/*') ? 'menu-open' : ''}}">
                <a href="{{route('vouchers.index')}}" class="nav-link {{request()->is('admin/vouchers') || request()->is('admin/vouchers/*') ? 'active' : ''}}">
...
{{--                    </li>--}}
            ...
            <li class="nav-item has-treeview {{request()->is('admin/orders') || request()->is('admin/orders/*') ? 'menu-open' : ''}}">
                <a href="{{route('orders.index')}}" class="nav-link {{request()->is('admin/orders') || request()->is('admin/orders/*') ? 'active' : ''}}">
...
{{--                    </li>--}}
            ...
            <li class="nav-item has-treeview {{request()->is('common/users') || request()->is('common/users/*') ? 'menu-open' : ''}}">
                <a href="#" class="nav-link {{request()->is('common/users') || request()->is('common/users/*') ? 'active' : ''}}">
            ...
            <li class="nav-item has-treeview  {{ request()->is('uptek/configs') || request()->is('uptek/customer-levels') || request()->is('uptek/accumulate-point/*') ? 'menu-open' : '' }} ">
                <a href="#" class="nav-link {{request()->is('uptek/configs') || request()->is('uptek/customer-levels') || request()->is('uptek/accumulate-point/*') ? 'active' : ''}}">
