...
@section('css')
    ...
    <style>
        ...
        .table-responsive .btn.btn-success {
            background-color: #b2d190 !important;
            color: #fff !important;
        }
        .table-responsive .btn.btn-danger {
            background-color: #8cc8a8 !important;
            color: #fff !important;
        }
    ...
    <script>
        app.controller('UserOrderController', function($scope) {
            let datatable = new DATATABLE('table-list', {
                ...
                columns: [
                    {data: 'DT_RowIndex', orderable: false, title: "STT", className: "text-center", width: "5%"},
                    {data: 'type', title: 'Loại đơn hàng', className: "text-center", width: "10%"},
                    {data: 'code_client', title: 'Mã', width: "10%"},
                    {data: 'total_price', title: 'Tổng tiền', width: "10%"},
                    {
                        data: 'status',
                        title: "Trạng thái",
                    ...
                    {data: 'created_at', title: 'Ngày đặt hàng', width: "10%"},
                    {data: 'action_client', title: 'Hành động', orderable: false, width: "10%"},
                ],
                search_columns: [
